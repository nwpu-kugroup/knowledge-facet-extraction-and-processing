package com.nupu.spider_Assemble.spiders.csdn;
...
//        }
        ...
        Spider csdnSpider = spiderCreate.create(new com.nupu.spider_Assemble.spiders.csdn.CSDNProcessor(this.spiderService))
