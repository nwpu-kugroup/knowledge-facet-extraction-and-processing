package com.nupu.spider_Assemble.spiders.toutiao;
...
//        }
        ...
        Spider toutiaoSpider = spiderCreate.create(new com.nupu.spider_Assemble.spiders.toutiao.ToutiaoProcessor(this.spiderService))
